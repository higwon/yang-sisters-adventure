...
export function SettingsPage() {
  ...
  const updateTrip = async (event: FormEvent<HTMLFormElement>) => { event.preventDefault(); const values = Object.fromEntries(new FormData(event.currentTarget)); await api.updateTrip(trip.id, values); setMessage('여행 설정을 저장했어요. 새로고침하면 전체 화면에 반영됩니다.'); };
