...
export function ExpensesPage() {
  ...
  return <section className="expensePage">
    <header className="expenseHeader"><div><small>TRIP EXPENSES</small><h1>여행 비용</h1><p>이번 여행에 사용한 원화 금액을 간단히 기록해요.</p></div><button className="expenseAdd" onClick={() => setEditing(null)}><Plus />비용 추가</button></header>
